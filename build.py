...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','dk.napp.ui.js')
	...
	f = os.path.join(cwd,'Classes','DkNappUiModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','dk.napp.ui.js']
